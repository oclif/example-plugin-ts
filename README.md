...
@oclif/example-plugin-ts/1.7.39 linux-x64 node-v10.0.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.7.39/src/commands/hello.ts)_
<!-- commandsstop -->
