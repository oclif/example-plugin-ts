...
@oclif/example-plugin-ts/1.7.4 linux-x64 node-v9.9.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.7.4/src/commands/hello.ts)_
<!-- commandsstop -->
