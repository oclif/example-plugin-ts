...
@oclif/example-plugin-ts/1.7.50 linux-x64 node-v10.2.1
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.7.50/src/commands/hello.ts)_
<!-- commandsstop -->
