...
@oclif/example-plugin-ts/1.8.0 linux-x64 node-v10.4.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.8.0/src/commands/hello.ts)_
<!-- commandsstop -->
