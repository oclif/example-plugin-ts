...
@oclif/example-plugin-ts/1.4.7 linux-x64 node-v9.9.0
...
_See code: [lib/commands/hello.js](https://github.com/oclif/example-plugin-ts/blob/v1.4.7/lib/commands/hello.js)_
<!-- commandsstop -->
