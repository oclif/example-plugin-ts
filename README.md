...
@oclif/example-plugin-ts/1.8.5 linux-x64 node-v10.5.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.8.5/src/commands/hello.ts)_
<!-- commandsstop -->
