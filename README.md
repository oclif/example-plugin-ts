...
@oclif/example-plugin-ts/1.7.27 linux-x64 node-v9.11.1
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.7.27/src/commands/hello.ts)_
<!-- commandsstop -->
