...
@oclif/example-plugin-ts/1.2.7 (linux-x64) node-v9.5.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.2.7/src/commands/hello.ts)_
<!-- commandsstop -->
