...
@oclif/example-plugin-ts/1.8.4 linux-x64 node-v10.4.1
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.8.4/src/commands/hello.ts)_
<!-- commandsstop -->
