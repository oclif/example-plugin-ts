...
@oclif/example-plugin-ts/1.5.2 linux-x64 node-v9.9.0
...
_See code: [lib/commands/hello.js](https://github.com/oclif/example-plugin-ts/blob/v1.5.2/lib/commands/hello.js)_
<!-- commandsstop -->
