...
@oclif/example-plugin-ts/1.3.7 (linux-x64) node-v9.6.1
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.3.8/src/commands/hello.ts)_
<!-- commandsstop -->
