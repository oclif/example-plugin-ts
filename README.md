...
@oclif/example-plugin-ts/1.10.4 linux-x64 node-v10.10.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.10.4/src/commands/hello.ts)_
<!-- commandsstop -->
