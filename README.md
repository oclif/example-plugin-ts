...
@oclif/example-plugin-ts/1.7.8 linux-x64 node-v9.10.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.7.8/src/commands/hello.ts)_
<!-- commandsstop -->
