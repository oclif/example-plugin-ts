...
@oclif/example-plugin-ts/1.3.11 (linux-x64) node-v9.8.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-plugin-ts/blob/v1.3.11/src/commands/hello.ts)_
<!-- commandsstop -->
